...
else
{
    ...
    if(keyboard_check_pressed(vk_shift) && go == 0 && stanima <= 22 - stanimacost)
    {
        stanima += stanimacost;
        stanwait = 60;
        if((vspd > 0 && hspd == 0) || (sprite_index == spr_player_downsprint && hspd == 0))
        {
            a = 1;
            sprite_index = spr_player_rolldown;
            image_index = 0;
            image_speed = .24 * rollspeed;
            rollback = 15;
        }
        ...
        else if((vspd < 0 && hspd == 0)|| (sprite_index == spr_player_upsprint && hspd == 0))
        {
            a = 1;
        ...
        else if((vspd == 0 && hspd > 0)|| (sprite_index == spr_player_rightsprint && vspd == 0))
        {
            a = 1;
        ...
        else if((vspd == 0 && hspd < 0)|| (sprite_index == spr_player_leftsprint && vspd == 0))
        {
            a = 1;
    ...
    if(stanima > 0 && stanwait == 0)
    {
        stanima -= stanimaspeed;
    }
    else if(stanima > 0 && stanwait > 0)
    {
        stanwait -= 1;
    }
    if(stanima < 0)
